...
namespace Argent
{
	namespace Helper
	{
		...
		//bool Collider::IntersectRayVsModel(const DirectX::XMFLOAT3& start, const DirectX::XMFLOAT3& end)
		...
		//				const ModelResource::Vertex& b = vertices.at(indices.at(index + static_cast<size_t>(1)));
		//				const ModelResource::Vertex& c = vertices.at(indices.at(index + static_cast<size_t>(2)));
		...
		//				if (t < 0.0f || t > neart) continue;	//交点までの距離が今までに計算した最近距離より大きいときはスキップ
